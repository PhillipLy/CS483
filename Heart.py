...
# heart1, heart2, heart9 and heart13 current best
heart = np.concatenate((heart1, heart34, heart8, heart9, heart13), axis=1)
...
# target[indices,0] = 0
#make sure to change this number here to access the targets
...
# Note, the values below give an accuracy of 91.7-94.5%
...
import mlp
net = mlp.mlp(train,traint,4,outtype='logistic')
